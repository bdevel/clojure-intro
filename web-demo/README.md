...
* [`src/clj/web_demo/`](src/clj/web_demo/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/web_demo/`](src/cljs/web_demo/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/web_demo/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `web-demo` project root directory
...
in the [`src/clj/web_demo/`](src/clj/web_demo/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/web_demo/config.cljs) defaults to `true` in
...
```clj
(ns web-demo.example
  (:require [web-demo.config :as config])
